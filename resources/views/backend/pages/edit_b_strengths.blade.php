...
<div class="container" >
  <div>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <a class="navbar-brand btn btn-primary" style="color: white" href="{{route('b_strengths')}}">page view</a>
  ...
  <div class="col-sm-12" style="margin-top: 20px"  >
     ...
     <form action="{{ URL::to('update-b-strengths/'.$edit_b_strengths->id)}}" method="post" enctype="multipart/form-data" >
      @csrf
       <!-----------------pseodo text area-------->
       <textarea id="php_post_text" name="php_post_text" placeholder="blog Description" class="form-control " style="display:none;"></textarea>
       <!----------------MAIN TEXT EDITOR-------->
      <textarea id ="y" class="form-control content" name="update_b_strengths">{{$edit_b_strengths->textbox}}</textarea>
