...
<head>
  ...
  <!-- textbar -->
  <link href="{{asset('public/assets/backend')}}/css/richtext.min.css" rel="stylesheet">
  <link href="{{asset('public/assets/backend')}}/css/sitetext.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="{{route('home_office_info')}}">
          <i class="fas fa-fw fa-table"></i>
          <span>Manage Office</span></a>
      </li>
      <!-- Nav Item - Tables -->
        <li class="nav-item">
          <a class="nav-link" href="{{route('home_create_product')}}">
            <i class="fas fa-fw fa-table"></i>
          <span>Create Product Name</span></a>
        </li>
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="{{route('home_image')}}">
          <i class="fas fa-fw fa-table"></i>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('managing_Director')}}">
          <i class="fas fa-fw fa-table"></i>
          <span>Manage Managing Director</span></a>
      </li>

      <!-- Nav Item - Tables -->
      {{-- <li class="nav-item">
        <a class="nav-link" href="{{route('see_about_us')}}">
          <i class="fas fa-fw fa-table"></i>
          <span>ABOUT US</span></a>
      </li>   <!-- Nav Item - Tables --> --}}
      <li class="nav-item">
        <a class="nav-link" href="{{route('message_submit_view')}}">
          <i class="fas fa-fw fa-table"></i>
          <span>Message</span></a>
      </li>
      <!-- Nav Item - Tables -->
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="{{route('all_career')}}">
          <i class="fas fa-fw fa-table"></i>
          <span>CAREER</span></a>
      </li>
      <!-- Nav Item - Tables -->
      {{-- <li class="nav-item">
        <a class="nav-link" href="{{route('b_strengths')}}">
          <i class="fas fa-fw fa-table"></i>
          <span>STRENGTHS</span></a>
      </li> --}}
      <!-- Nav Item - Tables -->
      {{-- <li class="nav-item">
